...
public class PlaneListOfActivities extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        final Call<List<Plane>> call = api.getPlane();
        call.enqueue(new Callback<List<Plane>>() {
            @Override
            public void onResponse(Call<List<Plane>> call,
                                   Response<List<Plane>> response) {
